...
@app.post("/signup")
async def signup(username: Annotated[str, Form()], email: Annotated[str, Form()], password: Annotated[str, Form()], full_name: Annotated[str, Form()] = None):
...
@app.get("/generate")
async def generate(current_user: Annotated[User, Depends(get_current_active_user)], notes: str, num_questions: int = 2):
    questions = []
